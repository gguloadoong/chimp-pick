...
| 작업 종류 | Issue | PR | 브랜치 |
|----------|-------|----|--------|
| `feat:` 새 기능 | 생성 | 생성 | `feature/설명` |
| `fix:` 버그 수정 | 생성 | 생성 | `fix/설명` |
| `refactor:` / `docs:` / `chore:` | 생략 | 생략 | main 직접 커밋 |

**라벨:** Issue/PR 생성 시 아래 두 종류를 **반드시 조합**하여 부착
1. `ai-generated` — AI가 개입된 모든 작업에 무조건 부착
2. 작업 성격 라벨 1개 이상: `enhancement`, `bug`, `documentation`, `refactor`, `design` 등
